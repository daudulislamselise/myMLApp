...
namespace MyMLApp
{
    ...
    {
        public const string RetrainFilePath =  @"F:\Selise_Office\Machine Learning\sentiment labelled sentences\sentiment labelled sentences\yelp_labelled.txt";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"col0",outputColumnName:@"col0")      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.OneVersusAll(binaryEstimator:mlContext.BinaryClassification.Trainers.FastForest(new FastForestBinaryTrainer.Options(){NumberOfTrees=28,NumberOfLeaves=68,FeatureFraction=0.9016298F,LabelColumnName=@"col1",FeatureColumnName=@"Features"}),labelColumnName:@"col1"))      
